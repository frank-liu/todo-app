...
describe("useTodos hook", () => {
  ...
  test("handleInputChange updates input value", () => {
    const { result } = renderHook(() => useTodos());
    act(() => {
      result.current.handleInputChange({ target: { value: "Task A" } });
    });
  ...
  test("adds a new todo with valid input and clears input", () => {
    const { result } = renderHook(() => useTodos());
    act(() => {
      result.current.handleInputChange({ target: { value: "First todo" } });
      result.current.handleAddTodo();
    });
  ...
  test("Enter key triggers add", () => {
    const { result } = renderHook(() => useTodos());
    act(() => {
      result.current.handleInputChange({ target: { value: "Enter add" } });
  ...
  test("non-Enter key does not add", () => {
    const { result } = renderHook(() => useTodos());
    act(() => {
      result.current.handleInputChange({ target: { value: "No add" } });
  ...
  test("toggle todo completed state by id", () => {
    const { result } = renderHook(() => useTodos());
    act(() => {
      result.current.handleInputChange({ target: { value: "Toggle me" } });
      result.current.handleAddTodo();
    });
  ...
  test("delete todo by id", () => {
    ...
    act(() => {
      ...
      result.current.handleAddTodo();
      result.current.handleInputChange({ target: { value: "B" } });
      result.current.handleAddTodo();
    });
  ...
  test("rapid double add only adds once (input clears after first add)", () => {
    const { result } = renderHook(() => useTodos());
    act(() => {
      result.current.handleInputChange({ target: { value: "Rapid" } });
      result.current.handleAddTodo();
